      ...
      <div className="relative w-full h-screen">
        ...
        <div className="relative flex flex-col items-center justify-center h-full text-white">
          <h1 className="text-4xl md:text-6xl font-bold text-center">
            <span className="mb-12">Welcome to{" "}</span>
            <span className="voltage-name relative">
              <span className="bg-gradient-to-r from-pink-600 via-violet-500 to-cyan-400 bg-clip-text text-transparent p-12">
                ByteBazaar{" "}
              </span>
              <svg
                version="1.1"
...
const StyledWrapper = styled.div`
  .voltage-name span + svg,
  .voltage-name span + svg + .dots {
    opacity: 1;
  }
  ...
  .voltage-name svg path {
    stroke-dasharray: 100;
    filter: url("#glow");
  }

  .voltage-name svg path.line-1 {
    stroke: #f6de8d;
    stroke-dashoffset: 0;
    animation: spark-1 3s linear infinite;
  }

  .voltage-name svg path.line-2 {
    stroke: #6bfeff;
  ...
  .voltage-name .dots .dot-1 {
    top: 0;
    left: 20%;
    animation: fly-up 3s linear infinite;
  }

  .voltage-name .dots .dot-2 {
    top: 0;
    left: 55%;
    animation: fly-up 3s linear infinite;
